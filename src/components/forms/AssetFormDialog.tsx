      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div><Label>Purchase Price</Label><Input type="number" min={0} step={0.01} value={form.purchase_price} onChange={e => setForm(f => ({ ...f, purchase_price: Number(e.target.value) }))} /></div>
            <div><Label>Current Value</Label><Input type="number" min={0} step={0.01} value={form.current_value} onChange={e => setForm(f => ({ ...f, current_value: Number(e.target.value) }))} /></div>
          </div>
          <div className="grid grid-cols-2 gap-3">
